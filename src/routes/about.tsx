...
function About() {
  ...
  return (
    <article className="mx-auto max-w-2xl px-5 pt-9 pb-8">
      <p className="section-label">About</p>
      <h1 className="display mt-2 text-4xl sm:text-5xl">About CRS Compass</h1>

      <h2 className="display mt-10 text-2xl">What Express Entry is</h2>
      ...
      <h2 className="display mt-10 text-2xl">
      ...
      <h2 className="display mt-10 text-2xl">There is no cutoff &ldquo;for Ontario&rdquo;</h2>
      <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
      ...
      <h2 className="display mt-10 text-2xl">Nobody can predict the next cutoff</h2>
      <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
      ...
      <h2 className="display mt-10 text-2xl">Disclaimer</h2>
      <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
      ...
      <h2 className="display mt-10 text-2xl">Credits and sources</h2>
